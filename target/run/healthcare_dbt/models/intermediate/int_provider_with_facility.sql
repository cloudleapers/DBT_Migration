  ...
  create or replace   view HEALTHCARE_DW.INTERMEDIATE.int_provider_with_facility
...
with providers as (
    select * from HEALTHCARE_DW.STAGING.stg_pg_providers
),

specialties as (
    select * from HEALTHCARE_DW.STAGING.stg_pg_specialty_types
),
