...
create or replace transient table HEALTHCARE_DW.MART.dim_payer
...
with carriers as (
    select * from HEALTHCARE_DW.STAGING.stg_pg_insurance_carriers
),
...
payer_types as (
    select * from HEALTHCARE_DW.STAGING.stg_mysql_payer_types
),
