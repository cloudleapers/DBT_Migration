...
create or replace transient table HEALTHCARE_DW.MART.dim_procedure
...
with cpt as (
    select * from HEALTHCARE_DW.STAGING.stg_pg_cpt_codes
),

billing as (
    select * from HEALTHCARE_DW.STAGING.stg_mysql_billing_codes
),
