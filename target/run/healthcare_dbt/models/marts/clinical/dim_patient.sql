...
create or replace transient table HEALTHCARE_DW.MART.dim_patient
...
with patients as (
    select * from HEALTHCARE_DW.INTERMEDIATE.int_patient_demographics
),

chronic as (
    select * from HEALTHCARE_DW.INTERMEDIATE.int_chronic_patients
),
