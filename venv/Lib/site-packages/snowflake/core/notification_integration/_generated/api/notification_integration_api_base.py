...
class NotificationIntegrationResourceBase(ObjectReferenceMixin["NotificationIntegrationCollection"]):
    ...
    def fetch(
        ...
        __________
        """
        result = self.collection._api.fetch_notification_integration(
            self._identifier,
            async_req=False,
        )
        return result
    ...
    def get_tags(
        ...
        Returns all tags assigned to a notification integration. This operation requires an active warehouse.
    ...
    def set_tags(
        ...
        """Set tags on a notification integration.
    ...
    def unset_tags(
        ...
        """Unset tags from a notification integration.
