...
from .catalog_integration_api import CatalogIntegrationApi
...
class CatalogIntegrationCollectionBase(AccountObjectCollectionParent["CatalogIntegrationResource"]):
    ...
    @api_telemetry
    def create(
        self, catalog_integration: CatalogIntegration, mode: Optional[Union[CreateMode, str]] = None
    ) -> "CatalogIntegrationResource":  # noqa: F821
        ...
        if self._identifier_requires_args:
            return self._ref_class(get_function_name_with_args(catalog_integration), self)
        return self._ref_class(catalog_integration.name, self)

    @api_telemetry
    def create_async(
        self, catalog_integration: CatalogIntegration, mode: Optional[Union[CreateMode, str]] = None
    ) -> PollingOperation["CatalogIntegrationResource"]:  # noqa: F821
        ...
        if self._identifier_requires_args:
            return PollingOperation(
                future, lambda _: self._ref_class(get_function_name_with_args(catalog_integration), self)
            )
        return PollingOperation(
            future,
            lambda _: self._ref_class(
                catalog_integration if isinstance(catalog_integration, str) else catalog_integration.name, self
            ),
        )
    ...
    def iter(self, *, like: Optional[str] = None) -> Iterator[CatalogIntegration]:
        ...
        """
        resources = self._api.list_catalog_integrations(
            like=like,
            async_req=False,
        )
...
class CatalogIntegrationResourceBase(ObjectReferenceMixin["CatalogIntegrationCollection"]):
    _collection_class: CatalogIntegrationCollectionBase
    _identifier_requires_args: bool = False
    _plural_name: str

    def __init__(self, name: str, collection_class: CatalogIntegrationCollectionBase) -> None:
    ...
    def fetch(
        ...
        __________
        """
        result = self.collection._api.fetch_catalog_integration(
            self._identifier,
            async_req=False,
        )
        return result
    ...
    def fetch_async(
        self,
    ) -> PollingOperation[CatalogIntegration]:
    ...
    def get_tags(
        ...
        """Get the tag assignments for a catalog integration.

        Returns all tags assigned to a catalog integration. This operation requires an active warehouse.
    ...
    def set_tags(
        ...
        """Set tags on a catalog integration.
    ...
    def unset_tags(
        ...
        """Unset tags from a catalog integration.
