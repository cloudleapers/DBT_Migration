...
from snowflake.core.sequence._generated import models
from snowflake.core.sequence._generated.models.sequence import Sequence
from snowflake.core.sequence._generated.models.success_response import SuccessResponse
...
class SequenceApi:
    ...
    def create_sequence(
        ...
        **kwargs,
        ...
        r"""Create a sequence  # noqa: E501

        Create a sequence  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True

        >>> future = api.create_sequence(database, var_schema, sequence, create_mode, async_req=True)
        ...
        return self.create_sequence_with_http_info(database, var_schema, sequence, create_mode, **kwargs)
    ...
    def create_sequence_with_http_info(
        ...
        **kwargs,
        ...
        >>> future = api.create_sequence_with_http_info(
        ...     database, var_schema, sequence, create_mode, async_req=True
        ... )
        >>> result = future.result()
        :param database: Identifier (i.e. name) for the database to which the resource belongs. You can use the `/api/v2/databases` GET request to get a list of available databases. (required)
        :type database: str
        ...
        _all_params = ["database", "var_schema", "sequence", "create_mode"]
        _all_params.extend(
            [
                "async_req",
        ...
        for _key, _val in _params["kwargs"].items():
            if _key not in _all_params:
                raise _APITypeError(f"Got an unexpected keyword argument '{_key}' to method create_sequence")
            _params[_key] = _val
        del _params["kwargs"]
    ...
    def clone_sequence(
        ...
        **kwargs,
        ...
        r"""Create a new sequence by cloning from the specified resource  # noqa: E501

        Create a new sequence by cloning from the specified resource  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True

        >>> future = api.clone_sequence(
        ...     database,
        ...     var_schema,
        ...     name,
        ...     sequence,
        ...
        """
        kwargs["_return_http_data_only"] = True
        return self.clone_sequence_with_http_info(
            database, var_schema, name, sequence, create_mode, target_database, target_schema, **kwargs
        )

    @validate_call
    def clone_sequence_with_http_info(
        self,
        database: Annotated[
            str,
            Field(
        ...
        **kwargs,
        ...
        >>> future = api.clone_sequence_with_http_info(
        ...     database,
        ...     var_schema,
        ...     name,
        ...     sequence,
        ...
        _all_params = ["database", "var_schema", "name", "sequence", "create_mode", "target_database", "target_schema"]
        _all_params.extend(
            [
                "async_req",
                "_return_http_data_only",
        ...
        for _key, _val in _params["kwargs"].items():
            if _key not in _all_params:
                raise _APITypeError(f"Got an unexpected keyword argument '{_key}' to method clone_sequence")
            _params[_key] = _val
        del _params["kwargs"]
    ...
    def fetch_sequence(
        ...
        async_req: bool = False,
        **kwargs,
    ) -> Union[Sequence, Future[Sequence]]: ...
    ...
    def fetch_sequence(
        ...
        **kwargs,
        ...
        r"""Fetch a sequence  # noqa: E501

        Fetch a sequence  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True

        >>> future = api.fetch_sequence(database, var_schema, name, async_req=True)
        >>> result = future.result()
        :param database: Identifier (i.e. name) for the database to which the resource belongs. You can use the `/api/v2/databases` GET request to get a list of available databases. (required)
        :type database: str
        :param var_schema: Identifier (i.e. name) for the schema to which the resource belongs. You can use the `/api/v2/databases/{database}/schemas` GET request to get a list of available schemas for the specified database. (required)
        ...
        :return: Returns the result object.
                 If the method is called asynchronously,
                 returns a Future object representing the execution of the method.
        :rtype: Union[Sequence, Future[Sequence]]
        """
        kwargs["_return_http_data_only"] = True
        return self.fetch_sequence_with_http_info(database, var_schema, name, **kwargs)

    @validate_call
    def fetch_sequence_with_http_info(
        self,
        database: Annotated[
            str,
            Field(
        ...
        **kwargs,
        ...
        >>> future = api.fetch_sequence_with_http_info(database, var_schema, name, async_req=True)
        >>> result = future.result()
        :param database: Identifier (i.e. name) for the database to which the resource belongs. You can use the `/api/v2/databases` GET request to get a list of available databases. (required)
        :type database: str
        :param var_schema: Identifier (i.e. name) for the schema to which the resource belongs. You can use the `/api/v2/databases/{database}/schemas` GET request to get a list of available schemas for the specified database. (required)
        ...
        :return: Returns the result object.
                 If the method is called asynchronously,
                 returns a Future object representing the execution of the method.
        :rtype: tuple(Union[Sequence, Future[Sequence]], status_code(int), headers(HTTPHeaderDict))
        """
        _params = locals()
        ...
        for _key, _val in _params["kwargs"].items():
            if _key not in _all_params:
                raise _APITypeError(f"Got an unexpected keyword argument '{_key}' to method fetch_sequence")
            _params[_key] = _val
        del _params["kwargs"]
    ...
    def list_sequences(
        ...
        async_req: bool = False,
        **kwargs,
    ) -> Union[Iterable[Sequence], Future[Iterable[Sequence]]]: ...
    ...
    def list_sequences(
        ...
        **kwargs,
        ...
        r"""List sequences  # noqa: E501

        List sequences  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True

        >>> future = api.list_sequences(database, var_schema, like, async_req=True)
        >>> result = future.result()
        :param database: Identifier (i.e. name) for the database to which the resource belongs. You can use the `/api/v2/databases` GET request to get a list of available databases. (required)
        :type database: str
        :param var_schema: Identifier (i.e. name) for the schema to which the resource belongs. You can use the `/api/v2/databases/{database}/schemas` GET request to get a list of available schemas for the specified database. (required)
        ...
        :return: Returns the result object.
                 If the method is called asynchronously,
                 returns a Future object representing the execution of the method.
        :rtype: Union[Iterable[Sequence], Future[Iterable[Sequence]]]
        """
        kwargs["_return_http_data_only"] = True
        return self.list_sequences_with_http_info(database, var_schema, like, **kwargs)
    ...
    def list_sequences_with_http_info(
        ...
        **kwargs,
        ...
        >>> future = api.list_sequences_with_http_info(database, var_schema, like, async_req=True)
        >>> result = future.result()
        :param database: Identifier (i.e. name) for the database to which the resource belongs. You can use the `/api/v2/databases` GET request to get a list of available databases. (required)
        :type database: str
        :param var_schema: Identifier (i.e. name) for the schema to which the resource belongs. You can use the `/api/v2/databases/{database}/schemas` GET request to get a list of available schemas for the specified database. (required)
        ...
        :return: Returns the result object.
                 If the method is called asynchronously,
                 returns a Future object representing the execution of the method.
        :rtype: tuple(Union[Iterable[Sequence], Future[Iterable[Sequence]]], status_code(int), headers(HTTPHeaderDict))
        """
        _params = locals()
        ...
        for _key, _val in _params["kwargs"].items():
            if _key not in _all_params:
                raise _APITypeError(f"Got an unexpected keyword argument '{_key}' to method list_sequences")
            _params[_key] = _val
        del _params["kwargs"]
    ...
    def rename_sequence(
        ...
        **kwargs,
        ...
        r"""Rename a sequence with a new identifier  # noqa: E501

        Rename a sequence with a new identifier  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True

        >>> future = api.rename_sequence(
        ...     database,
        ...     var_schema,
        ...     name,
        ...     target_name,
    ...
    def rename_sequence_with_http_info(
        ...
        **kwargs,
        ...
        >>> future = api.rename_sequence_with_http_info(
        ...     database,
        ...     var_schema,
        ...     name,
        ...     target_name,
        ...
        for _key, _val in _params["kwargs"].items():
            if _key not in _all_params:
                raise _APITypeError(f"Got an unexpected keyword argument '{_key}' to method rename_sequence")
            _params[_key] = _val
        del _params["kwargs"]
    ...
    def delete_sequence(
        ...
        **kwargs,
        ...
        >>> future = api.delete_sequence(database, var_schema, name, if_exists, async_req=True)
        >>> result = future.result()
        :param database: Identifier (i.e. name) for the database to which the resource belongs. You can use the `/api/v2/databases` GET request to get a list of available databases. (required)
        :type database: str
        :param var_schema: Identifier (i.e. name) for the schema to which the resource belongs. You can use the `/api/v2/databases/{database}/schemas` GET request to get a list of available schemas for the specified database. (required)
        ...
        """
        kwargs["_return_http_data_only"] = True
        return self.delete_sequence_with_http_info(database, var_schema, name, if_exists, **kwargs)
    ...
    def delete_sequence_with_http_info(
        ...
        **kwargs,
        ...
        >>> future = api.delete_sequence_with_http_info(database, var_schema, name, if_exists, async_req=True)
        >>> result = future.result()
        :param database: Identifier (i.e. name) for the database to which the resource belongs. You can use the `/api/v2/databases` GET request to get a list of available databases. (required)
        :type database: str
        :param var_schema: Identifier (i.e. name) for the schema to which the resource belongs. You can use the `/api/v2/databases/{database}/schemas` GET request to get a list of available schemas for the specified database. (required)
        ...
        for _key, _val in _params["kwargs"].items():
            if _key not in _all_params:
                raise _APITypeError(f"Got an unexpected keyword argument '{_key}' to method delete_sequence")
            _params[_key] = _val
        del _params["kwargs"]
