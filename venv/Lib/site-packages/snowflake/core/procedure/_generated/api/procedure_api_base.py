...
class ProcedureResourceBase(SchemaObjectReferenceMixin["ProcedureCollection"]):
    ...
    def call(
        ...
        call_argument_list: CallArgumentList
             (required)
        """
        result = self.collection._api.call_procedure(
            self.database.name,
            self.schema.name,
            self._identifier,
    ...
    def fetch(
        ...
        __________
        """
        result = self.collection._api.fetch_procedure(
            self.database.name,
            self.schema.name,
            self._identifier,
            async_req=False,
    ...
    def get_tags(
        ...
        Returns all tags assigned to a procedure. This operation requires an active warehouse.
