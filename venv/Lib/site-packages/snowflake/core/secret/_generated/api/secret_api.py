...
from snowflake.core.secret._generated import models
...
class SecretApi:
    ...
    def create_secret(
        ...
        **kwargs,
        ...
        >>> future = api.create_secret(database, var_schema, secret, create_mode, async_req=True)
        ...
        return self.create_secret_with_http_info(database, var_schema, secret, create_mode, **kwargs)
    ...
    def create_secret_with_http_info(
        ...
        **kwargs,
        ...
        >>> future = api.create_secret_with_http_info(database, var_schema, secret, create_mode, async_req=True)
        >>> result = future.result()
        :param database: Identifier (i.e. name) for the database to which the resource belongs. You can use the `/api/v2/databases` GET request to get a list of available databases. (required)
        :type database: str
        :param var_schema: Identifier (i.e. name) for the schema to which the resource belongs. You can use the `/api/v2/databases/{database}/schemas` GET request to get a list of available schemas for the specified database. (required)
        ...
        _all_params = ["database", "var_schema", "secret", "create_mode"]
        _all_params.extend(
            [
                "async_req",
        ...
        for _key, _val in _params["kwargs"].items():
            if _key not in _all_params:
                raise _APITypeError(f"Got an unexpected keyword argument '{_key}' to method create_secret")
            _params[_key] = _val
        del _params["kwargs"]
    ...
    def fetch_secret(
        ...
        **kwargs,
        ...
        r"""Fetch a secret  # noqa: E501

        Fetch a secret  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True

        >>> future = api.fetch_secret(database, var_schema, name, async_req=True)
        >>> result = future.result()
        :param database: Identifier (i.e. name) for the database to which the resource belongs. You can use the `/api/v2/databases` GET request to get a list of available databases. (required)
        :type database: str
        :param var_schema: Identifier (i.e. name) for the schema to which the resource belongs. You can use the `/api/v2/databases/{database}/schemas` GET request to get a list of available schemas for the specified database. (required)
        ...
        :return: Returns the result object.
                 If the method is called asynchronously,
                 returns a Future object representing the execution of the method.
        :rtype: Union[Secret, Future[Secret]]
        """
        kwargs["_return_http_data_only"] = True
        return self.fetch_secret_with_http_info(database, var_schema, name, **kwargs)

    @validate_call
    def fetch_secret_with_http_info(
        self,
        database: Annotated[
            str,
            Field(
        ...
        **kwargs,
        ...
        >>> future = api.fetch_secret_with_http_info(database, var_schema, name, async_req=True)
        >>> result = future.result()
        :param database: Identifier (i.e. name) for the database to which the resource belongs. You can use the `/api/v2/databases` GET request to get a list of available databases. (required)
        :type database: str
        :param var_schema: Identifier (i.e. name) for the schema to which the resource belongs. You can use the `/api/v2/databases/{database}/schemas` GET request to get a list of available schemas for the specified database. (required)
        ...
        :return: Returns the result object.
                 If the method is called asynchronously,
                 returns a Future object representing the execution of the method.
        :rtype: tuple(Union[Secret, Future[Secret]], status_code(int), headers(HTTPHeaderDict))
        """
        _params = locals()
        ...
        for _key, _val in _params["kwargs"].items():
            if _key not in _all_params:
                raise _APITypeError(f"Got an unexpected keyword argument '{_key}' to method fetch_secret")
            _params[_key] = _val
        del _params["kwargs"]
    ...
    def list_secrets(
        ...
        async_req: bool = False,
        **kwargs,
    ) -> Union[Iterable[Secret], Future[Iterable[Secret]]]: ...
    ...
    def list_secrets(
        ...
        **kwargs,
        ...
        :return: Returns the result object.
                 If the method is called asynchronously,
                 returns a Future object representing the execution of the method.
        :rtype: Union[Iterable[Secret], Future[Iterable[Secret]]]
        """
        kwargs["_return_http_data_only"] = True
    ...
    def list_secrets_with_http_info(
        ...
        **kwargs,
        ...
        >>> future = api.list_secrets_with_http_info(
        ...     database, var_schema, like, starts_with, show_limit, from_name, async_req=True
        ... )
        >>> result = future.result()
        :param database: Identifier (i.e. name) for the database to which the resource belongs. You can use the `/api/v2/databases` GET request to get a list of available databases. (required)
        ...
        :return: Returns the result object.
                 If the method is called asynchronously,
                 returns a Future object representing the execution of the method.
        :rtype: tuple(Union[Iterable[Secret], Future[Iterable[Secret]]], status_code(int), headers(HTTPHeaderDict))
        """
        _params = locals()
        ...
        for _key, _val in _params["kwargs"].items():
            if _key not in _all_params:
                raise _APITypeError(f"Got an unexpected keyword argument '{_key}' to method list_secrets")
            _params[_key] = _val
        del _params["kwargs"]
    ...
    def delete_secret(
        ...
        **kwargs,
        ...
        >>> future = api.delete_secret(database, var_schema, name, if_exists, async_req=True)
        >>> result = future.result()
        :param database: Identifier (i.e. name) for the database to which the resource belongs. You can use the `/api/v2/databases` GET request to get a list of available databases. (required)
        :type database: str
        :param var_schema: Identifier (i.e. name) for the schema to which the resource belongs. You can use the `/api/v2/databases/{database}/schemas` GET request to get a list of available schemas for the specified database. (required)
        ...
        """
        kwargs["_return_http_data_only"] = True
        return self.delete_secret_with_http_info(database, var_schema, name, if_exists, **kwargs)
    ...
    def delete_secret_with_http_info(
        ...
        **kwargs,
        ...
        >>> future = api.delete_secret_with_http_info(database, var_schema, name, if_exists, async_req=True)
        >>> result = future.result()
        :param database: Identifier (i.e. name) for the database to which the resource belongs. You can use the `/api/v2/databases` GET request to get a list of available databases. (required)
        :type database: str
        :param var_schema: Identifier (i.e. name) for the schema to which the resource belongs. You can use the `/api/v2/databases/{database}/schemas` GET request to get a list of available schemas for the specified database. (required)
        ...
        for _key, _val in _params["kwargs"].items():
            if _key not in _all_params:
                raise _APITypeError(f"Got an unexpected keyword argument '{_key}' to method delete_secret")
            _params[_key] = _val
        del _params["kwargs"]
