...
class NetworkPolicyApi:
    ...
    def get_tags(
        ...
        **kwargs,
        ...
        r"""Get the tag assignments for a network policy.  # noqa: E501

        Returns all tags assigned to a network policy. This operation requires an active warehouse.  # noqa: E501
    ...
    def get_tags_with_http_info(
        ...
        **kwargs,
        ...
        return self.api_client.call_api(
            self._root,
            "/api/v2/network-policies/{name}:get-tags",
            "GET",
            _path_params,
            _query_params,
            _header_params,
    ...
    def set_tags(
        ...
        **kwargs,
        ...
        r"""Set tags on a network policy.  # noqa: E501

        Set tags on a network policy.  # noqa: E501
    ...
    def set_tags_with_http_info(
        ...
        **kwargs,
        ...
        return self.api_client.call_api(
            self._root,
            "/api/v2/network-policies/{name}:set-tags",
            "POST",
            _path_params,
            _query_params,
            _header_params,
    ...
    def unset_tags(
        ...
        **kwargs,
        ...
        r"""Unset tags from a network policy.  # noqa: E501

        Unset tags from a network policy.  # noqa: E501
    ...
    def unset_tags_with_http_info(
        ...
        **kwargs,
        ...
        return self.api_client.call_api(
            self._root,
            "/api/v2/network-policies/{name}:unset-tags",
            "POST",
            _path_params,
            _query_params,
            _header_params,
