...
from snowflake.core.task._generated import models
...
class TaskApi:
    ...
    def fetch_task_dependents(
        ...
        **kwargs,
        ...
        Returns a list of the dependent tasks of the task with identifier {name}. This operation requires an active warehouse.  # noqa: E501
    ...
    def get_complete_graphs(
        ...
        **kwargs,
        ...
        Returns details for graph runs that are completed. This operation requires an active warehouse.  # noqa: E501
    ...
    def get_current_graphs(
        ...
        **kwargs,
        ...
        Returns details for graph runs that are currently executing or are next scheduled to run within the next 8 days. This operation requires an active warehouse.  # noqa: E501
    ...
    def get_tags(
        ...
        **kwargs,
        ...
        r"""Get the tag assignments for the task.  # noqa: E501

        Returns all tags assigned to the task. This operation requires an active warehouse.  # noqa: E501
    ...
    def get_tags_with_http_info(
        ...
        **kwargs,
        ...
        return self.api_client.call_api(
            self._root,
            "/api/v2/databases/{database}/schemas/{schema}/tasks/{name}:get-tags",
            "GET",
            _path_params,
            _query_params,
            _header_params,
    ...
    def list_tasks(
        ...
        root_only: Annotated[
            Optional[StrictBool],
            Field(
                description="Parameter to filter the command output to return only root resources (resources with no predecessors)."
            ),
        ] = None,
        like: Annotated[
            Optional[StrictStr],
    ...
    def list_tasks(
        ...
        **kwargs,
        ...
        :param var_schema: Identifier (i.e. name) for the schema to which the resource belongs. You can use the `/api/v2/databases/{database}/schemas` GET request to get a list of available schemas for the specified database. (required)
        :type var_schema: str
        :param root_only: Parameter to filter the command output to return only root resources (resources with no predecessors).
        :type root_only: bool
    ...
    def set_tags(
        ...
        **kwargs,
        ...
        r"""Set tags on an existing task.  # noqa: E501

        Sets tags on an existing task.  # noqa: E501
    ...
    def set_tags_with_http_info(
        ...
        **kwargs,
        ...
        return self.api_client.call_api(
            self._root,
            "/api/v2/databases/{database}/schemas/{schema}/tasks/{name}:set-tags",
            "POST",
            _path_params,
            _query_params,
            _header_params,
    ...
    def unset_tags(
        ...
        **kwargs,
        ...
        r"""Unset tags from an existing task.  # noqa: E501

        Unsets tags from an existing task.  # noqa: E501
    ...
    def unset_tags_with_http_info(
        ...
        **kwargs,
        ...
        return self.api_client.call_api(
            self._root,
            "/api/v2/databases/{database}/schemas/{schema}/tasks/{name}:unset-tags",
            "POST",
            _path_params,
            _query_params,
            _header_params,
