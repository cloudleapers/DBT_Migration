...
class PasswordPolicyResourceBase(SchemaObjectReferenceMixin["PasswordPolicyCollection"]):
    ...
    def fetch(
        ...
        __________
        """
        result = self.collection._api.fetch_password_policy(
            self.database.name,
            self.schema.name,
            self._identifier,
            async_req=False,
    ...
    def get_tags(
        ...
        Returns all tags assigned to a password policy. This operation requires an active warehouse.
    ...
    def unset_tags(
        ...
        """Unset tags from a password policy.
