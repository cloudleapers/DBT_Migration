...
from snowflake.core.password_policy._generated import models
...
class PasswordPolicyApi:
    ...
    def __init__(self, root, resource_class, sproc_client):
        self._root = root
        self._resource_name = "password_policy"
    ...
    def create_password_policy(
        ...
        **kwargs,
        ...
        r"""Create a password policy  # noqa: E501

        Create a password policy  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True

        >>> future = api.create_password_policy(
        ...     database, var_schema, password_policy, create_mode, async_req=True
        ... )
        ...
        return self.create_password_policy_with_http_info(database, var_schema, password_policy, create_mode, **kwargs)
    ...
    def create_password_policy_with_http_info(
        ...
        **kwargs,
        ...
        >>> future = api.create_password_policy_with_http_info(
        ...     database, var_schema, password_policy, create_mode, async_req=True
        ... )
        >>> result = future.result()
        :param database: Identifier (i.e. name) for the database to which the resource belongs. You can use the `/api/v2/databases` GET request to get a list of available databases. (required)
        ...
        _all_params = ["database", "var_schema", "password_policy", "create_mode"]
        _all_params.extend(
            [
                "async_req",
        ...
        for _key, _val in _params["kwargs"].items():
            if _key not in _all_params:
                raise _APITypeError(f"Got an unexpected keyword argument '{_key}' to method create_password_policy")
            _params[_key] = _val
        del _params["kwargs"]
    ...
    def fetch_password_policy(
        ...
        async_req: bool = False,
        **kwargs,
    ) -> Union[PasswordPolicy, Future[PasswordPolicy]]: ...
    ...
    def fetch_password_policy(
        ...
        **kwargs,
        ...
        r"""Fetch a password policy  # noqa: E501

        Fetch a password policy  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True

        >>> future = api.fetch_password_policy(database, var_schema, name, async_req=True)
        >>> result = future.result()
        :param database: Identifier (i.e. name) for the database to which the resource belongs. You can use the `/api/v2/databases` GET request to get a list of available databases. (required)
        :type database: str
        :param var_schema: Identifier (i.e. name) for the schema to which the resource belongs. You can use the `/api/v2/databases/{database}/schemas` GET request to get a list of available schemas for the specified database. (required)
        ...
        :return: Returns the result object.
                 If the method is called asynchronously,
                 returns a Future object representing the execution of the method.
        :rtype: Union[PasswordPolicy, Future[PasswordPolicy]]
        """
        kwargs["_return_http_data_only"] = True
        return self.fetch_password_policy_with_http_info(database, var_schema, name, **kwargs)

    @validate_call
    def fetch_password_policy_with_http_info(
        self,
        database: Annotated[
            str,
            Field(
        ...
        **kwargs,
        ...
        >>> future = api.fetch_password_policy_with_http_info(database, var_schema, name, async_req=True)
        >>> result = future.result()
        :param database: Identifier (i.e. name) for the database to which the resource belongs. You can use the `/api/v2/databases` GET request to get a list of available databases. (required)
        :type database: str
        :param var_schema: Identifier (i.e. name) for the schema to which the resource belongs. You can use the `/api/v2/databases/{database}/schemas` GET request to get a list of available schemas for the specified database. (required)
        ...
        :return: Returns the result object.
                 If the method is called asynchronously,
                 returns a Future object representing the execution of the method.
        :rtype: tuple(Union[PasswordPolicy, Future[PasswordPolicy]], status_code(int), headers(HTTPHeaderDict))
        """
        _params = locals()
        ...
        for _key, _val in _params["kwargs"].items():
            if _key not in _all_params:
                raise _APITypeError(f"Got an unexpected keyword argument '{_key}' to method fetch_password_policy")
            _params[_key] = _val
        del _params["kwargs"]
    ...
    def get_tags(
        ...
        **kwargs,
        ...
        r"""Get the tag assignments for a password policy.  # noqa: E501

        Returns all tags assigned to a password policy. This operation requires an active warehouse.  # noqa: E501
    ...
    def list_password_policies(
        ...
        async_req: Literal[True] = True,
        **kwargs,
    ) -> Future[Iterable[PasswordPolicy]]: ...
    ...
    def list_password_policies(
        ...
        async_req: bool = False,
        **kwargs,
    ) -> Union[Iterable[PasswordPolicy], Future[Iterable[PasswordPolicy]]]: ...
    ...
    def list_password_policies(
        ...
        **kwargs,
        ...
        r"""List password policies  # noqa: E501
        ...
        >>> future = api.list_password_policies(
        ...     database, var_schema, like, starts_with, show_limit, async_req=True
        ... )
        >>> result = future.result()
        :param database: Identifier (i.e. name) for the database to which the resource belongs. You can use the `/api/v2/databases` GET request to get a list of available databases. (required)
        :type database: str
        ...
        :return: Returns the result object.
                 If the method is called asynchronously,
                 returns a Future object representing the execution of the method.
        :rtype: Union[Iterable[PasswordPolicy], Future[Iterable[PasswordPolicy]]]
        """
        kwargs["_return_http_data_only"] = True
        return self.list_password_policies_with_http_info(database, var_schema, like, starts_with, show_limit, **kwargs)
    ...
    def list_password_policies_with_http_info(
        ...
        **kwargs,
        ...
        >>> future = api.list_password_policies_with_http_info(
        ...     database, var_schema, like, starts_with, show_limit, async_req=True
        ... )
        >>> result = future.result()
        :param database: Identifier (i.e. name) for the database to which the resource belongs. You can use the `/api/v2/databases` GET request to get a list of available databases. (required)
        ...
        :return: Returns the result object.
                 If the method is called asynchronously,
                 returns a Future object representing the execution of the method.
        :rtype: tuple(Union[Iterable[PasswordPolicy], Future[Iterable[PasswordPolicy]]], status_code(int), headers(HTTPHeaderDict))
        """
        _params = locals()

        _all_params = ["database", "var_schema", "like", "starts_with", "show_limit"]
        _all_params.extend(
            [
                "async_req",
                "_return_http_data_only",
        ...
        for _key, _val in _params["kwargs"].items():
            if _key not in _all_params:
                raise _APITypeError(f"Got an unexpected keyword argument '{_key}' to method list_password_policies")
            _params[_key] = _val
        del _params["kwargs"]
    ...
    def rename_password_policy(
        ...
        **kwargs,
        ...
        r"""Rename a password policy with a new identifier  # noqa: E501

        Rename a password policy with a new identifier  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True

        >>> future = api.rename_password_policy(
        ...     database,
        ...     var_schema,
        ...     name,
        ...     target_name,
        ...
        """
        kwargs["_return_http_data_only"] = True
        return self.rename_password_policy_with_http_info(
            database, var_schema, name, target_name, if_exists, target_database, target_schema, **kwargs
        )

    @validate_call
    def rename_password_policy_with_http_info(
        self,
        database: Annotated[
            str,
            Field(
        ...
        **kwargs,
        ...
        >>> future = api.rename_password_policy_with_http_info(
        ...     database,
        ...     var_schema,
        ...     name,
        ...     target_name,
        ...
        for _key, _val in _params["kwargs"].items():
            if _key not in _all_params:
                raise _APITypeError(f"Got an unexpected keyword argument '{_key}' to method rename_password_policy")
            _params[_key] = _val
        del _params["kwargs"]
    ...
    def set_tags(
        ...
        **kwargs,
        ...
        r"""Set tags on a password policy.  # noqa: E501

        Set tags on a password policy.  # noqa: E501
    ...
    def unset_tags(
        ...
        **kwargs,
        ...
        r"""Unset tags from a password policy.  # noqa: E501

        Unset tags from a password policy.  # noqa: E501
    ...
    def delete_password_policy(
        ...
        **kwargs,
        ...
        r"""Delete a password policy  # noqa: E501

        Delete a password policy  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True

        >>> future = api.delete_password_policy(database, var_schema, name, if_exists, async_req=True)
        >>> result = future.result()
        :param database: Identifier (i.e. name) for the database to which the resource belongs. You can use the `/api/v2/databases` GET request to get a list of available databases. (required)
        :type database: str
        :param var_schema: Identifier (i.e. name) for the schema to which the resource belongs. You can use the `/api/v2/databases/{database}/schemas` GET request to get a list of available schemas for the specified database. (required)
        ...
        """
        kwargs["_return_http_data_only"] = True
        return self.delete_password_policy_with_http_info(database, var_schema, name, if_exists, **kwargs)
    ...
    def delete_password_policy_with_http_info(
        ...
        **kwargs,
        ...
        >>> future = api.delete_password_policy_with_http_info(
        ...
        for _key, _val in _params["kwargs"].items():
            if _key not in _all_params:
                raise _APITypeError(f"Got an unexpected keyword argument '{_key}' to method delete_password_policy")
            _params[_key] = _val
        del _params["kwargs"]
