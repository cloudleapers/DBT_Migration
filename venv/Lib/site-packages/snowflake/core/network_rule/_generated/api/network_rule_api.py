...
from snowflake.core.network_rule._generated import models
...
class NetworkRuleApi:
    ...
    def __init__(self, root, resource_class, sproc_client):
        self._root = root
        self._resource_name = "network_rule"
    ...
    def create_network_rule(
        ...
        **kwargs,
        ...
        r"""Create a network rule  # noqa: E501

        Create a network rule  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True

        >>> future = api.create_network_rule(database, var_schema, network_rule, create_mode, async_req=True)
        ...
        :type var_schema: str
        :param network_rule: (required)
        :type network_rule: NetworkRule
        ...
        return self.create_network_rule_with_http_info(database, var_schema, network_rule, create_mode, **kwargs)

    @validate_call
    def create_network_rule_with_http_info(
        self,
        database: Annotated[
            str,
            Field(
        ...
        **kwargs,
        ...
        >>> future = api.create_network_rule_with_http_info(
        ...     database, var_schema, network_rule, create_mode, async_req=True
        ... )
        >>> result = future.result()
        :param database: Identifier (i.e. name) for the database to which the resource belongs. You can use the `/api/v2/databases` GET request to get a list of available databases. (required)
        :type database: str
        ...
        _all_params = ["database", "var_schema", "network_rule", "create_mode"]
        _all_params.extend(
            [
                "async_req",
        ...
        for _key, _val in _params["kwargs"].items():
            if _key not in _all_params:
                raise _APITypeError(f"Got an unexpected keyword argument '{_key}' to method create_network_rule")
            _params[_key] = _val
        del _params["kwargs"]
    ...
    def fetch_network_rule(
        ...
        async_req: bool = False,
        **kwargs,
    ) -> Union[NetworkRule, Future[NetworkRule]]: ...
    ...
    def fetch_network_rule(
        ...
        **kwargs,
        ...
        r"""Fetch a network rule  # noqa: E501

        Fetch a network rule  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True

        >>> future = api.fetch_network_rule(database, var_schema, name, async_req=True)
        >>> result = future.result()
        :param database: Identifier (i.e. name) for the database to which the resource belongs. You can use the `/api/v2/databases` GET request to get a list of available databases. (required)
        :type database: str
        :param var_schema: Identifier (i.e. name) for the schema to which the resource belongs. You can use the `/api/v2/databases/{database}/schemas` GET request to get a list of available schemas for the specified database. (required)
        ...
        :return: Returns the result object.
                 If the method is called asynchronously,
                 returns a Future object representing the execution of the method.
        :rtype: Union[NetworkRule, Future[NetworkRule]]
        """
        kwargs["_return_http_data_only"] = True
        return self.fetch_network_rule_with_http_info(database, var_schema, name, **kwargs)

    @validate_call
    def fetch_network_rule_with_http_info(
        self,
        database: Annotated[
            str,
            Field(
        ...
        **kwargs,
        ...
        >>> future = api.fetch_network_rule_with_http_info(database, var_schema, name, async_req=True)
        >>> result = future.result()
        :param database: Identifier (i.e. name) for the database to which the resource belongs. You can use the `/api/v2/databases` GET request to get a list of available databases. (required)
        :type database: str
        :param var_schema: Identifier (i.e. name) for the schema to which the resource belongs. You can use the `/api/v2/databases/{database}/schemas` GET request to get a list of available schemas for the specified database. (required)
        ...
        :return: Returns the result object.
                 If the method is called asynchronously,
                 returns a Future object representing the execution of the method.
        :rtype: tuple(Union[NetworkRule, Future[NetworkRule]], status_code(int), headers(HTTPHeaderDict))
        """
        _params = locals()
        ...
        for _key, _val in _params["kwargs"].items():
            if _key not in _all_params:
                raise _APITypeError(f"Got an unexpected keyword argument '{_key}' to method fetch_network_rule")
            _params[_key] = _val
        del _params["kwargs"]
    ...
    def list_network_rules(
        ...
        async_req: bool = False,
        **kwargs,
    ) -> Union[Iterable[NetworkRule], Future[Iterable[NetworkRule]]]: ...
    ...
    def list_network_rules(
        ...
        **kwargs,
        ...
        r"""List network rules  # noqa: E501

        List network rules  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True

        >>> future = api.list_network_rules(
        ...
        :return: Returns the result object.
                 If the method is called asynchronously,
                 returns a Future object representing the execution of the method.
        :rtype: Union[Iterable[NetworkRule], Future[Iterable[NetworkRule]]]
        """
        kwargs["_return_http_data_only"] = True
        return self.list_network_rules_with_http_info(
            database, var_schema, like, starts_with, show_limit, from_name, **kwargs
        )

    @validate_call
    def list_network_rules_with_http_info(
        self,
        database: Annotated[
            str,
            Field(
        ...
        **kwargs,
        ...
        >>> future = api.list_network_rules_with_http_info(
        ...     database, var_schema, like, starts_with, show_limit, from_name, async_req=True
        ... )
        >>> result = future.result()
        :param database: Identifier (i.e. name) for the database to which the resource belongs. You can use the `/api/v2/databases` GET request to get a list of available databases. (required)
        ...
        :return: Returns the result object.
                 If the method is called asynchronously,
                 returns a Future object representing the execution of the method.
        :rtype: tuple(Union[Iterable[NetworkRule], Future[Iterable[NetworkRule]]], status_code(int), headers(HTTPHeaderDict))
        """
        _params = locals()
        ...
        for _key, _val in _params["kwargs"].items():
            if _key not in _all_params:
                raise _APITypeError(f"Got an unexpected keyword argument '{_key}' to method list_network_rules")
            _params[_key] = _val
        del _params["kwargs"]
    ...
    def delete_network_rule(
        ...
        **kwargs,
        ...
        r"""Delete a network rule  # noqa: E501
        ...
        >>> future = api.delete_network_rule(database, var_schema, name, if_exists, async_req=True)
        >>> result = future.result()
        :param database: Identifier (i.e. name) for the database to which the resource belongs. You can use the `/api/v2/databases` GET request to get a list of available databases. (required)
        :type database: str
        :param var_schema: Identifier (i.e. name) for the schema to which the resource belongs. You can use the `/api/v2/databases/{database}/schemas` GET request to get a list of available schemas for the specified database. (required)
        ...
        """
        kwargs["_return_http_data_only"] = True
        return self.delete_network_rule_with_http_info(database, var_schema, name, if_exists, **kwargs)

    @validate_call
    def delete_network_rule_with_http_info(
        self,
        database: Annotated[
            str,
            Field(
        ...
        **kwargs,
        ...
        >>> future = api.delete_network_rule_with_http_info(
        ...
        for _key, _val in _params["kwargs"].items():
            if _key not in _all_params:
                raise _APITypeError(f"Got an unexpected keyword argument '{_key}' to method delete_network_rule")
            _params[_key] = _val
        del _params["kwargs"]
