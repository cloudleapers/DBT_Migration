...
from snowflake.core.compute_pool._generated import models
...
class ComputePoolApi:
    ...
    def get_tags(
        ...
        **kwargs,
        ...
        r"""Get the tag assignments for a compute pool.  # noqa: E501

        Returns all tags assigned to a compute pool. This operation requires an active warehouse.  # noqa: E501
    ...
    def get_tags_with_http_info(
        ...
        **kwargs,
        ...
        return self.api_client.call_api(
            self._root,
            "/api/v2/compute-pools/{name}:get-tags",
            "GET",
            _path_params,
            _query_params,
            _header_params,
    ...
    @overload
    def list_compute_pool_instance_families(
        self, async_req: Literal[False] = False, **kwargs
    ) -> Iterable[ComputePoolInstanceFamily]: ...

    @overload
    def list_compute_pool_instance_families(
        self, async_req: Literal[True] = True, **kwargs
    ) -> Future[Iterable[ComputePoolInstanceFamily]]: ...

    @overload
    def list_compute_pool_instance_families(
        self, async_req: bool = False, **kwargs
    ) -> Union[Iterable[ComputePoolInstanceFamily], Future[Iterable[ComputePoolInstanceFamily]]]: ...

    @validate_call
    def list_compute_pool_instance_families(
        self, **kwargs
    ) -> Union[Iterable[ComputePoolInstanceFamily], Future[Iterable[ComputePoolInstanceFamily]]]:
        r"""Lists available compute pool instance families.  # noqa: E501

        Lists all available instance families that can be used when creating compute pools.  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True

        >>> future = api.list_compute_pool_instance_families(async_req=True)
        >>> result = future.result()
        :param async_req: Whether to execute the request asynchronously.
        :type async_req: bool, optional
        :param _preload_content: if False, the urllib3.HTTPResponse object will
        ...
        :return: Returns the result object.
                 If the method is called asynchronously,
                 returns a Future object representing the execution of the method.
        :rtype: Union[Iterable[ComputePoolInstanceFamily], Future[Iterable[ComputePoolInstanceFamily]]]
        """
        kwargs["_return_http_data_only"] = True
        return self.list_compute_pool_instance_families_with_http_info(**kwargs)

    @validate_call
    def list_compute_pool_instance_families_with_http_info(self, **kwargs):
        r"""Lists available compute pool instance families.  # noqa: E501
        ...
        >>> future = api.list_compute_pool_instance_families_with_http_info(async_req=True)
        >>> result = future.result()
        :param async_req: Whether to execute the request asynchronously.
        :type async_req: bool, optional
        :param _return_http_data_only: response data without head status code
        ...
        :return: Returns the result object.
                 If the method is called asynchronously,
                 returns a Future object representing the execution of the method.
        :rtype: tuple(Union[Iterable[ComputePoolInstanceFamily], Future[Iterable[ComputePoolInstanceFamily]]], status_code(int), headers(HTTPHeaderDict))
        """
        _params = locals()
        ...
        for _key, _val in _params["kwargs"].items():
            if _key not in _all_params:
                raise _APITypeError(
                    f"Got an unexpected keyword argument '{_key}' to method list_compute_pool_instance_families"
                )
            _params[_key] = _val
        del _params["kwargs"]
        ...
        _response_types_map = {
            "200": "Iterable[ComputePoolInstanceFamily]",
            "202": "SuccessAcceptedResponse",
            "400": "ErrorResponse",
            "401": "ErrorResponse",
            "403": "ErrorResponse",
        ...
        return self.api_client.call_api(
            self._root,
            "/api/v2/compute-pools/instance-families",
            "GET",
            _path_params,
            _query_params,
            _header_params,
    ...
    def set_tags(
        ...
        **kwargs,
        ...
        r"""Set tags on a compute pool.  # noqa: E501

        Set tags on a compute pool.  # noqa: E501
    ...
    def set_tags_with_http_info(
        ...
        **kwargs,
        ...
        return self.api_client.call_api(
            self._root,
            "/api/v2/compute-pools/{name}:set-tags",
            "POST",
            _path_params,
            _query_params,
            _header_params,
    ...
    def unset_tags(
        ...
        **kwargs,
        ...
        r"""Unset tags from a compute pool.  # noqa: E501

        Unset tags from a compute pool.  # noqa: E501
    ...
    def unset_tags_with_http_info(
        ...
        **kwargs,
        ...
        return self.api_client.call_api(
            self._root,
            "/api/v2/compute-pools/{name}:unset-tags",
            "POST",
            _path_params,
            _query_params,
            _header_params,
