...
class DynamicTableResourceBase(SchemaObjectReferenceMixin["DynamicTableCollection"]):
    ...
    def fetch(
        ...
        __________
        """
        result = self.collection._api.fetch_dynamic_table(
            self.database.name,
            self.schema.name,
            self._identifier,
            async_req=False,
    ...
    def get_tags(
        ...
        Returns all tags assigned to a dynamic table. This operation requires an active warehouse.
    ...
    def unset_tags(
        ...
        """Unset tags from a dynamic table.
